...
main (int argc, char *argv[])
{
  ...
  Config::SetDefault("ns3::MpTcpSocketBase::PathManagement", EnumValue(FullMesh));
...
//  Config::SetDefault("ns3::MpTcpSocketBase::PathManagement", StringValue("NdiffPorts"));
  ...
  MpTcpBulkSendHelper source("ns3::TcpSocketFactory", InetSocketAddress(Ipv4Address(csmaInterfaces.GetAddress(nCsma-1)), port));
